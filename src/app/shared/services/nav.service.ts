    ...
    PRODUCTIONMENUITEMS: Menu[] = [
        ...
        { headTitle: 'Missions' },
        {
            ...
            children: [
                ...
                { path: '/missions/my-missions', title: 'Mes missions', type: 'link' },
                { path: '/missions/all-missions', title: 'Toutes les missions', type: 'link' },
                // { path: '/missions/upload-cv', title: 'Uploader un CV', type: 'link' }
            ]
        } ,
      {
            title: 'Utlilisateurs', icon: 'widgets', type: 'sub', active: false,
            children: [
        ...
        { headTitle: 'CRA' },
        {
            title: 'CRA', icon: 'widgets', type: 'sub', active: false,
            children: [
              {path: '/cra/create-activity', title: 'Compte rendu d\'activité', type: 'link'},
              { path: '/cra/mes-cra', title: 'Mes CRA', type: 'link' },
              { path: '/cra/toutes-les-cra', title: 'Toutes les CRA', type: 'link'}, // Ajoutez isAdmin:true pour limiter l'accès aux ADMIN
              // { path: '/cra/toutes-les-cra', title: 'Toutes les CRA', type: 'link', isAdmin: true }, // Ajoutez isAdmin:true pour limiter l'accès aux ADMIN
            ]
        },
      { headTitle: 'Contacts' },
