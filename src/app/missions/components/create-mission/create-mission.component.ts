...
export class CreateMissionComponent {
  ...
  addMission() {
    ...
    const newMission = {
      ...
      freeDays: this.missionForm.value.freeDays,
      isForMe: this.missionForm.value.isForMe,
      sellDays: this.missionForm.value.sellDays,
      shareMission: this.missionForm.value.shareMission,
      startDate: this.missionForm.value.startDate,
      tjm: this.missionForm.value.tjm
    };

    this.missionService.createMission(newMission).subscribe(mission => {
      this.toastr.success('Mission added successfully!');
      this.resetForm();
    }, error => {
      this.toastr.error('Failed to add mission');
    });
  }
